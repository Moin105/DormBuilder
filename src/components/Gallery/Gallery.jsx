...
//           (selectedBedrooms === "" || item.rooms === parseInt(selectedBedrooms))
//       ),
...
//           <h2>
//             The Comfort of your <span className="link">Home</span>
//           </h2>
...
//                 return (
//                   <div
//                     className="col-sm-12 col-md-6 col-lg-4 dormGalleryCards"
//                     style={{ display: "flex" }}
//                   >
//                     <div
...
//                           )}
//                         </span>
//                         {dorm?.dorm_images[0]?.image_url ? (
//                           <img
//                             className="card-img-top"
//                             src={`https://backend.uni-hive.net/storage/${dorm?.dorm_images[0]?.image_url}`}
//                             alt=""
//                           />
//                         ) : (
//                           <img
...
//                         onClick={() => handleDormDetails(dorm.id)}
//                       >
//                         <div
//                           className="card-title"
//                           dangerouslySetInnerHTML={{ __html: dorm?.dorm_id }}
//                         >
//                           {/* {dorm?.dorm_id} */}
//                         </div>
